...
export const memory = {
  ...
  "subtitle": "",
  "text": "24x7 All type of segment cars available",
  "img": memoryimg,
  "experience": [
    { "number": "4", "title": "Year Experience" },
    { "number": "3+", "title": "Cars & Vans available" },
    { "number": "50+", "title": "Happy Customer" },
  ],
};
export const bemory = {
  "title": "GET IN TOUCH",
  ...
  "img": banner,
  "experience": [
    { "number": "MAIL", "title": "sbtravels02@gmail.com" },
    { "number": "ADDRESS", "title": "No:12, Rane trw,Venkateshwara Nagar, Padma Avenue,Guduvancherry " },
    { "number": "CONTACT", "title": "8248791813" },
  ],
};
