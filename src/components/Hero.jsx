    ...
    <>
      ...
      <div className='flex flex-col h-auto w-auto bg-gradient-to-b from-red-200 to-blue-500' >
        <div className='travigo-container grid items-start justify-items-center '>
          ...
          <div className='h-[75vh] w-[95vh] lg:w-[95vh] md:w-[57vh] sm:w-[45vh] xsm:w-[35vh] h-[55vh] lg:h-[25vh] md:h-[25vh] sm:h-[25vh] bg-relative bg-contain bg-center rounded-2xl drop-shadow-emrald'style={{backgroundImage: `url(${backgroundImage})`, transition:"2s"}}>
